...
\begin{verbatim}
Views/Manager/___.cshtml where ___ is a view associated with a given function within the model
\end{verbatim}
\end{itemize}
...
\\
\subsection{Prototype Deliverable Detail: Current Project Status}

\subsection{Documentation and Tutorial Reference Guide}
