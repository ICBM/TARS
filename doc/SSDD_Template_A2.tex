...
\author{Idaho Cost and Budget Management}
\date{\today}
\begin{document}
\clearpage\setcounter{page}{1}\pagestyle{Standard}
\thispagestyle{FirstPage}
{\centering\selectlanguage{english}\bfseries\color{black}
System and Software Design Document for the \\Idaho Department of Health and Welfare's Cost Management System  
\par}
...
{\centering\selectlanguage{english}\bfseries\color{black}
the Idaho Department of Health and Welfare's Cost and Budget Management System
\par}
