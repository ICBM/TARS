...
Since TARS is being developed for IIS7, our databases will be in SQL2008 format. Any queries made by the MVC will be carried out by the "Model" component of the MVC. \\
...
These controllers do not yet have a finalized set of associated functions and variables. When that is complete a description will reside here.
\begin{itemize}
\item HomeController
\item UserController
...
\end{verbatim}
These connections are not conventional classes or objects. To indicate this, their naming conventions are slightly more verbose. 
\subsubsection{Views}
\begin{itemize}
...
As mentioned above in the Software Architecture section, TARS will use a SQL2008 database to store all interactions other than User Info. Before outlining the Database Schema, it would be wise to fully describe the thought process of the development team.\\
\\
